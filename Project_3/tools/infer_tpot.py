...
KNOWN = [
    ("59.32-fp8  (v0.22.1)",  59.32, 55, 79, 6),
    ("T1-chunk4096 (v0.22.1)", 58.44, 58, 84, 6),
    ("P1-bf16 (v0.22.1)",     46.78, 61, 100, 8),
    ("A1-w4a16 (v0.25.1!)",   48.90, 55, 78, 7),   # ⚠️ 2 BIẾN: quant + version (Marlin)
    ("T4-fp8 (v0.25.1)",      60.17, 52, 71, 5),   # nền mới sau version bump
    ("T5-omp1 (v0.25.1)",     60.62, 49, 75, 6),   # BEST — T4 + OMP_NUM_THREADS=1
]
